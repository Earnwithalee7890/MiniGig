...
const address = MINI_GIG_CORE_ADDRESS;
```

## 🌟 Talent Protocol Support

This package includes configurations for Talent Protocol integration, ensuring that reputation data (Builder Score) can be verified against on-chain activity recorded by these contracts.
